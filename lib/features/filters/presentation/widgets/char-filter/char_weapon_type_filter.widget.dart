...
class CharWeaponTypeFilter extends ConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SmartSelect<WeaponType>.multiple(
      ...
      onChange: (state) {
        ref.read(charFilterProvider.notifier).updateWeaponTypes(state.value);
      },
          ...
          child: Row(
            children: <Widget>[
              ...
              TextButton(
                ...
                onPressed: () {
                  ref.read(charFilterProvider.notifier).updateWeaponTypes([]);

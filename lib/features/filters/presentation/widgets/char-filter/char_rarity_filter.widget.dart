...
class CharRarityFilter extends ConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SmartSelect<int>.multiple(
      ...
      onChange: (state) {
        ref.read(charFilterProvider.notifier).updateRarities(state.value);
      },
          ...
          child: Row(
            children: <Widget>[
              ...
              TextButton(
                ...
                onPressed: () {
                  ref.read(charFilterProvider.notifier).updateRarities([]);
